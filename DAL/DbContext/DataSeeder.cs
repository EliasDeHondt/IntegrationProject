...
public class DataSeeder
{
    private static void GenerateSingleQuestions(CodeForgeDbContext ctx,Flow flow)
    {
        ...
        ctx.Choices.AddRange(choice1, choice2, choice3, choice4, choice5,choice6, choice7,choice8, choice9, choice10, choice11, choice12, choice13, choice14, choice15, choice16, choice17, choice18, choice19, choice20, choice21, choice22);
    ...
    private static void GenerateMultipleCQuestions(CodeForgeDbContext ctx,Flow flow)
    {
        ...
        Choice choice13 = new Choice("Een overleg waarbij ik onderwerpen kan aandragen die voor jongeren belangrijk zijn");
        ...
        ctx.Choices.AddRange(choice, choice1, choice2, choice3, choice4, choice5, choice6, choice7, choice8, choice9, choice10, choice11, choice12, choice13, choice14, choice15, choice16, choice17, choice18, choice19, choice20, choice21, choice22, choice23, choice24);
    ...
    private static void GenerateRangeQuestions(CodeForgeDbContext ctx,Flow flow)
    {
        ...
        ctx.Choices.AddRange(choice19, choice20, choice21, choice22, choice1, choice2, choice3, choice4, choice5, choice6, choice7, choice8, choice9, choice10, choice11, choice12, choice13, choice14, choice15, choice16, choice17, choice18, choice);
    ...
    {  
        ...
        Video videoInfo = new Video("/Assets/Videos/Rocket_League_in_Wheelchair_meme.mp4");
