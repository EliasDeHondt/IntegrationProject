...
export function generatePlatformCards(platforms: SharedPlatform[]): string {
    ...
    return `<li class="col-6 list-item">
                    <button id="btnAddPlatform" class="card col flex-row d-flex align-items-center me-4 ms-2 mb-3 sys-card">
...
export function generatePlatformCard(platform: SharedPlatform): string {
    ...
    return `<li class="col-6 list-item">
                <a class="card col flex-row d-flex align-items-center me-4 ms-2 mb-3 sys-card" href="/SharedPlatform/Dashboard/${platform.id}">
