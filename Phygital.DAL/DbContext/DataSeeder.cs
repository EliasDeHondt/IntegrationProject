...
{
    private static void GenerateSingleAnswers(CodeForgeDbContext dbContext,
        SingleChoiceQuestion singleChoiceQuestion, Choice choice)
    {
        ...
        int stepIndexFlow)
    {
        ...
        {
            case 1:
                SingleChoiceQuestion singleQuestions1 = new SingleChoiceQuestion(
                    "If you were to prepare the budget for your city or municipality, where would you mainly focus on in the coming years? Choose one.");
                ...
                break;
            case 2:
                SingleChoiceQuestion singleQuestions2 = new SingleChoiceQuestion(
                    "What do you think is the most important thing that the city park should offer? Choose one.");
                ...
                break;
            case 3:
                SingleChoiceQuestion singleQuestion3 = new SingleChoiceQuestion(
                    "What aspect of sustainable development do you consider most crucial for the future? Choose one.");
                ...
                break;
            case 4:
                SingleChoiceQuestion singleQuestion4 = new SingleChoiceQuestion(
                    "Which of the following do you believe is the most effective approach towards achieving sustainable development? Choose one.");
    ...
    private static void GenerateMultipleChoiceQuestions(CodeForgeDbContext dbContext, Flow flow, int caseIndex,
        int stepIndexFlow)
    {
        switch (caseIndex)
        {
            case 1:
                MultipleChoiceQuestion multipleChoiceQuestions1 =
                    new MultipleChoiceQuestion("What would help you make a choice between the different parties?");

                Choice choice1 = new Choice("More lessons at school about party programs",
                ...
                break;
            case 2:
                MultipleChoiceQuestion multipleChoiceQuestions2 =
                    new MultipleChoiceQuestion(
                        "What do you think is the most important thing that the city park should offer?");
                ...
                break;
            case 3:
                MultipleChoiceQuestion multipleChoiceQuestions3 =
                    new MultipleChoiceQuestion(
                        "How can technology best contribute to promoting equal access to education and opportunities for underprivileged communities? (Select all that apply)");

                Choice choice11 = new Choice("Providing online educational resources", multipleChoiceQuestions3);
                Choice choice12 = new Choice("Offering mentorship programs and digital skills",
                    multipleChoiceQuestions3);
                Choice choice13 = new Choice("Facilitating access to affordable internet",
                    multipleChoiceQuestions3);
                Choice choice14 = new Choice("Supporting community-based organizations", multipleChoiceQuestions3);
                Choice choice15 = new Choice("Developing innovative solutions for healthcare",
                    multipleChoiceQuestions3);
                Choice choice16 = new Choice("Empowering local entrepreneurs and small business",
                    multipleChoiceQuestions3);
    ...
    private static void GenerateRangeQuestions(CodeForgeDbContext dbContext, Flow flow, int caseIndex,
        int stepIndexFlow)
    {
        switch (caseIndex)
        {
            case 1:
                RangeQuestion rangeQuestions1 =
                    new RangeQuestion("Are you planning to vote in the upcoming local elections?");
                ...
                break;
            case 2:
                RangeQuestion rangeQuestions2 = new RangeQuestion(
                    "How important do you think it is that the new city park is a place where everyone feels welcome?");
    ...
    private static void GenerateOpenQuestions(CodeForgeDbContext dbContext, Flow flow, int caseIndex,
        int stepIndexFlow)
    {
        switch (caseIndex)
        {
            case 1:
                OpenQuestion openQuestions1 =
                    new OpenQuestion(
                ...
                break;
            case 2:
                OpenQuestion openQuestions2 =
                    new OpenQuestion(
                        "If you could wish for one thing for the new city park, what would your dream city park definitely include? Please provide your thoughts.");
                ...
                break;
            case 3:
                OpenQuestion openQuestions3 =
                    new OpenQuestion(
                        "In your opinion, what role should businesses play in promoting sustainable development? Please provide your thoughts.");
            ...
            case 4:
                ...
                break;
            case 5:
                OpenQuestion openQuestions5 =
                    new OpenQuestion(
                        "How can communities better integrate environmental sustainability into urban planning and development? Share your ideas.");
                ...
                break;
            case 6:
                OpenQuestion openQuestions6 =
                    new OpenQuestion(
                        "What measures do you believe are necessary to address the challenges of climate change adaptation in vulnerable regions? Provide your insights.");
                ...
                break;
            case 7:
                OpenQuestion openQuestions7 =
                    new OpenQuestion(
                        "How can technology be harnessed to promote sustainable agriculture and food security? Share your thoughts.");
                ...
                break;
            case 8:
                OpenQuestion openQuestions8 =
                    new OpenQuestion(
                        "In what ways do you believe sustainable consumption and production patterns can be encouraged among individuals and communities? Offer your perspectives.");
    ...
    private static void GenerateConditonalQuestions(CodeForgeDbContext dbContext, Flow flow)
    {
        ...
        SingleChoiceQuestion singleChoiceQuestion = new SingleChoiceQuestion(
            "Which area of technology do you believe will revolutionize daily life the most in the next decade? Choose one.");
        ...
        MultipleChoiceQuestion multipleChoiceQuestion1 = new MultipleChoiceQuestion(
            "How do you think technology can best contribute to environmental sustainability and combating climate change? (Select all that apply)");
        ...
        MultipleChoiceQuestion multipleChoiceQuestion2 = new MultipleChoiceQuestion(
            "What measures do you think are necessary to ensure the ethical development and use of emerging technologies? (Select all that apply)");
        ...
        RangeQuestion rangeQuestion =
            new RangeQuestion(
                "How concerned are you about the ethical implications of emerging technologies such as artificial intelligence and biotechnology?");
        ...
        OpenQuestion openQuestions1 =
            new OpenQuestion(
                "What role do you think education should play in fostering a culture of sustainability among future generations? Share your ideas.");
        ...
        OpenQuestion openQuestions2 =
            new OpenQuestion(
                "In what ways do you think technology can be harnessed to empower marginalized communities and promote social justice? Share your thoughts.");
        ...
        OpenQuestion openQuestions3 =
            new OpenQuestion(
                "How can we ensure that technological innovation is guided by ethical principles and values that prioritize the well-being of society and the environment? Provide your insights.");
        ...
        // Add notes
        step1.Notes.Add(new Note(
            "The user is optimistic about the transformative potential of AI. They emphasize a balanced perspective, acknowledging both the benefits and challenges of AI integration into daily life."));
        step4.Notes.Add(
            new Note("They recognize both the potential benefits and risks associated with these technologies."));
        step4.Notes.Add(new Note(
            "The user advocates for proactive measures to address ethical concerns and ensure responsible development and deployment of emerging technologies."));
        step5.Notes.Add(new Note(
            "The user views education as a crucial driver for fostering a culture of sustainability. They highlight a comprehensive approach, integrating sustainability into various aspects of education and community involvement."));
    }
    ...
    public static void GenerateKdgSteps(CodeForgeDbContext dbContext, Flow flowKdg)
    {
        ...
        Hyperlink hyperlinkInfoKdg =
            new Hyperlink(
                "https://studentkdg.sharepoint.com/sites/intranet-nl/SitePages/verkiezingen-StuRa.aspx?from=SendByEmail&e=zIeoHeJOsUW7zyhNtRfGkQ&at=9");
    ...
    private static void GenerateSingleQuestionsKdg(CodeForgeDbContext dbContext, Flow flow, int caseIndex,
        int stepNumber)
    {
        switch (caseIndex)
        {
            case 1:
                SingleChoiceQuestion singleQuestions1 = new SingleChoiceQuestion(
                    "Welke van de volgende gebieden zou jij prioriteit geven voor verbetering in onze hogeschool voor het komende academische jaar? Kies er een.");

                Choice choice1 = new Choice("Het verbeteren van de diensten voor studentenondersteuning",
                    singleQuestions1);
                Choice choice2 =
                    new Choice("Het bevorderen van de betrokkenheid van studenten en buitenschoolse activiteiten",
                        singleQuestions1);
                Choice choice3 = new Choice("Het verbeteren van de faciliteiten en infrastructuur van de campus",
                    singleQuestions1);
                Choice choice4 = new Choice("Het verbeteren van academische programma's en middelen",
                    singleQuestions1);
                Choice choice5 = new Choice("Het waarborgen van studentenvertegenwoordiging en belangenbehartiging",
                    singleQuestions1);
                Choice choice6 = new Choice("Het bevorderen van diversiteit en inclusieve initiatieven",
                    singleQuestions1);
            ...
            case 2:
                SingleChoiceQuestion singleQuestions2 = new SingleChoiceQuestion(
                    "Welke kwaliteiten acht jij het belangrijkst voor een succesvolle vertegenwoordiger van de studentenraad? Kies er een.");
            ...
            case 3:
                SingleChoiceQuestion singleQuestions3 = new SingleChoiceQuestion(
                    "Hoe zou jij de prioritering van de toewijzing van fondsen voor studentenactiviteiten en -evenementen zien? Kies er een.");

                Choice choice13 = new Choice("Gelijkmatig over alle soorten evenementen", singleQuestions3);
                Choice choice14 = new Choice("Gebaseerd op de voorkeuren en interesses van studenten",
                    singleQuestions3);
                Choice choice15 = new Choice("Prioriteit geven aan grote jaarlijkse evenementen", singleQuestions3);
                Choice choice16 = new Choice("Ondersteuning van nieuwe en innovatieve initiatieven",
                    singleQuestions3);
                Choice choice17 = new Choice("Fondsen toewijzen op basis van eerdere successen van evenementen",
                    singleQuestions3);
    ...
    private static void GenerateMultipleChoiceQuestionsKdg(CodeForgeDbContext dbContext, Flow flow, int caseIndex,
        int stepNumber)
    {
        switch (caseIndex)
        {
            case 1:
                MultipleChoiceQuestion multipleQuestions1 = new MultipleChoiceQuestion(
                    "Wat beschouw jij als de belangrijkste verantwoordelijkheden van een studentenraadslid?");
                ...
                Choice choice3 = new Choice("Bevorderen van diversiteit en inclusie op de campus",
                    multipleQuestions1);
                Choice choice4 = new Choice("Bijdragen aan de academische besluitvorming", multipleQuestions1);
                Choice choice5 = new Choice("Samenwerken met de schooladministratie voor verbeteringen",
                    multipleQuestions1);
            ...
            case 2:
                MultipleChoiceQuestion multipleQuestions2 = new MultipleChoiceQuestion(
                    "Welke eigenschappen acht jij essentieel voor een effectieve studentenraadsvertegenwoordiger?");
            ...
            case 3:
                MultipleChoiceQuestion multipleQuestions3 = new MultipleChoiceQuestion(
                    "Op welke gebieden zou jij als studentenraadslid prioriteit geven aan verbeteringen binnen de school?");

                Choice choice13 = new Choice("Verbeteren van studie- en academische ondersteuningsdiensten",
                    multipleQuestions3);
                Choice choice14 = new Choice("Bevorderen van studentenwelzijn en geestelijke gezondheid",
                    multipleQuestions3);
                Choice choice15 = new Choice("Uitbreiden van de betrokkenheid van studenten bij de gemeenschap",
                    multipleQuestions3);
                Choice choice16 = new Choice("Verbeteren van faciliteiten en voorzieningen op de campus",
                    multipleQuestions3);
    ...
    {
        RangeQuestion rangeQuestion =
            new RangeQuestion("Studenten zouden meer invloed moeten hebben binnen het schoolbestuur");
    ...
    private static void GenerateOpenQuestionsKdg(CodeForgeDbContext dbContext, Flow flow, int stepNumber)
    {
        OpenQuestion openQuestion =
            new OpenQuestion("Leg in je eigen woorden uit wat jij zou willen veranderen aan KdG");
    ...
    public static void Seed(CodeForgeDbContext dbContext)
    {
        ...
        Respondent respondent3 = new Respondent("Tam@mail.com", participation3);
        ...
        flow4.Participations.Add(participation3);
        ...
        Project project1 = new Project(mainTheme1.Subject, mainTheme1, sharedPlatform,
            "Local elections let community members choose local officials like mayors and city council members. These elections impact local policies, public services, and community development. Voting in local elections helps shape the leadership and direction of the community, addressing everyday issues like education, safety, and infrastructure.");
        ...
        //=======================
        ProjectOrganizer projectOrganizer1 = new ProjectOrganizer(project1,
        ...
        ProjectOrganizer projectOrganizer2 = new ProjectOrganizer(project2,
            (Facilitator)dbContext.Users.Single(user => user.Email == "Tom@CodeForge.com"));
        ProjectOrganizer projectOrganizer3 = new ProjectOrganizer(project4,
            (Facilitator)dbContext.Users.Single(user => user.Email == "Fred@kdg.be"));
        ProjectOrganizer projectOrganizer4 = new ProjectOrganizer(project3,
            (Facilitator)dbContext.Users.Single(user => user.Email == "Tom@CodeForge.com"));
        ...
        //=======================
        dbContext.SharedPlatforms.RemoveRange(
            dbContext.SharedPlatforms.Where(p => p.OrganisationName == string.Empty));
